...
export default function FormularioElegante() {
              ...
              <Box sx={{ mt: 4 }}>
                ...
                {checklistSections.map((section, sectionIndex) => (
                  ...
                  >
                    ...
                    >
                      <Typography variant="subtitle1" sx={{ fontWeight: 'bold', color: theme.palette.primary.main }}>{section.title}</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
